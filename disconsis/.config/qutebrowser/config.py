...
## Type: Dict
USERSCRIPT_DIR = '/home/ketan/.git/qutebrowser/misc/userscripts/'
...
## Type: Dict
# c.bindings.key_mappings = {'<Ctrl-6>': '<Ctrl-^>', '<Ctrl-[>': '<Escape>', '<Shift-Enter>': '<Return>', '<Ctrl-M>': '<Return>', '<Ctrl-Enter>': '<Ctrl-Return>', '<Ctrl-J>': '<Return>', '<Shift-Return>': '<Return>', '<Enter>': '<Return>'}
...
## Type: QtColor
c.colors.tabs.selected.even.bg = 'darkcyan'
...
c.content.host_blocking.lists.append('file:///home/ketan/.config/qutebrowser/hosts')
...
## Type: Dict
# c.content.javascript.log = {'error': 'debug', 'warning': 'debug', 'info': 'debug', 'unknown': 'debug'}
...
config.bind('<ctrl+y>', 'scroll-px 0 -23')
